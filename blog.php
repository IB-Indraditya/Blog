        ...
        <div class="container">
            ...
            <?php
                ...
                $sql = "SELECT posts.*, 
                            ...
                            (SELECT COUNT(*) FROM post_likes WHERE post_likes.post_id = posts.id AND post_likes.user_email = ?) AS user_liked
                        FROM blogregister
                        INNER JOIN posts ON posts.author_email = blogregister.email
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        $commentSql = "SELECT * FROM comments WHERE post_id = $postId ORDER BY created_at ASC";
            ...
            <div class="add-post" id='toolbar'>
                <a href="writepad.php">Add New Post</a>
            </div>
        </div>
